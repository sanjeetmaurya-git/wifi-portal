    ...
    <div class="container" style="padding: 40px 20px;">
        ...
        <div
            ...
            @foreach($plans as $plan)
                <div
                    style="background: white; border-radius: 12px; padding: 30px; width: 280px; text-align: center; box-shadow: 0 10px 25px rgba(0,0,0,0.05); transition: transform 0.3s ease;">
                    ...
                    <div style="text-align: left; margin-bottom: 30px; border-top: 1px solid #eee; padding-top: 20px;">
                        ...
                        <div style="margin-bottom: 10px; color: #555;">🚀 <b>Speed:</b>
                            {{ $plan->upload_limit }}/{{ $plan->download_limit }}</div>
                        <div style="margin-bottom: 10px; color: #555;">📊 <b>Data Limit:</b>
                            {{ $plan->data_limit_mb / 1000 ?? 'Unlimited' }} GB</div>
                    </div>
